            ...
            ColumnLayout {
                ...
                Connections {
                    ...
                    function onAuthenticationRequestStarted() {
                        passwordInput.text = "";
                        passwordInput.field.forceActiveFocus();
                    }
                }
                ...
                StyledTextField {
                    ...
                    placeholder: agent.flow?.inputPrompt || "Password"
                    echoMode: (agent.flow?.responseVisible ?? false)
                        ? TextInput.Normal : TextInput.Password
                    field.onAccepted: form._submit()
                    field.Keys.onEscapePressed: form._cancel()
                }
